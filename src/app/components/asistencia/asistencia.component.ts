...
export class AsistenciaComponent implements OnInit   {
  ...
  ngOnInit(): void {
      this.htmlStr="";
      this.htmlStrModals="";
      this.httpClient.get('https://l9ikb48a81.execute-api.us-east-1.amazonaws.com/Dev/asistencia')
      .subscribe(response => {
        ...
        for (let i =0;i < items.length; i++){
          ...
          if(items[i]['t03_estatus']=="Activo"){
            console.log("Activo este si se pinta");
            ...
            if(flag_row==0){
              ...
              componente="<div class=\"row\">";
                ...
                if(flag_col<2){
                  ...
                  "<img alt=\"Burger King descuentos\" src=\""+items[i]['t03_imagenurls3']+"\" />"+
                  "<div class=\"OtroSegInfo\">"+
                  "<h3 class=\"OtroSegTitle\">"+items[i]['t03_titulo']+"</h3>"+
                  "<p class=\"OtroSegDesc\">"+items[i]['t03_descripcion']+"</p>"+
                  "<p class=\"OtroSegCod\">Código: <span>ABC123</span></p>"+
                  "<p class=\"OtroSegDate\">Valido hasta el 12 de Julio de 2020</p>"+
                  "<a id=\"modal-otroseg02\" href=\"#modal-container-asistseg0"+i+"\" "+
                  "data-toggle=\"modal\" role=\"button\" class=\"btn btn-primary Benef\">"+
                  "MÁS DETALLE</a></div></div>";



                  modal="<div class=\"modal fade\" id=\"modal-container-asistseg0"+i+"\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">"+
                           "<div class=\"modal-dialog\" role=\"document\">"+
                               "<div class=\"modal-content AdqOtroSegModal01\">"+
                                   ...
                                   "<div class=\"modal-body\">"+
                                      "<div class=\"imagen\">"+
                                          "<img src=\""+items[i]['t03_imagenurls3']+"\" alt=\"Asistencia Telefónica\">"+
                                      "</div>"+
                                      "<div class=\"OtroSegInfo\">"+
                                       "<p class=\"OtroSegCod\">Código: <span>ABC123</span></p>"+
                                       "<p class=\"OtroSegDesc\">"+items[i]['t03_descripcion']+
                                       "</p>"+
                                       "<p class=\"OtroSegDate\">Valido hasta el 12 de Julio de 2020</p>"+
                                   "</div>"+
                                   "</div>"+
                  ...
                  componente=componente+"<div class=\"col-12 col-md-4\">"+
