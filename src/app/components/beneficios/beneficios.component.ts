...
export class BeneficiosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.httpClient.get('https://l9ikb48a81.execute-api.us-east-1.amazonaws.com/Dev/beneficios/')
    .subscribe(response => {
          ...
          if(flag_row==0){
            ...
            componente="<div class=\"row\">";
              ...
              if(flag_col<2){
                ...
                "<img alt=\"Burger King descuentos\" src=\""+items[i]['t02_imagenurls3']+"\" />"+
                "<div class=\"OtroSegInfo\">"+
                "<h3 class=\"OtroSegTitle\">"+items[i]['t02_titulo']+"</h3>"+
                "<p class=\"OtroSegDesc\">"+items[i]['t02_descripcion']+"</p>"+
                ...
                "data-toggle=\"modal\" role=\"button\" class=\"btn btn-primary Benef\" href=\"#modal-container-otroseg0"+i+"\" >"+
                ...
                modal="<div class=\"modal fade\" id=\"modal-container-otroseg0"+i+"\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">"+
                  ...
                  "<div class=\"modal-content AdqOtroSegModal01\">"+
                      "<div class=\"modal-header rojo\">"+
                          "<h5 class=\"modal-title\" id=\"myModalLabel\">"+items[i]['t02_titulo']+"</h5>"+
                          "<button type=\"button\" class=\"close\" data-dismiss=\"modal\">"+
                              "<span aria-hidden=\"true\">×</span>"+
                          "</button></div><div class=\"modal-body\">"+
                         "<div class=\"imagen\">"+
                             "<img src=\""+items[i]['t02_imagenurls3']+"\" alt=\"Burger king\">"+
                         "</div><div class=\"OtroSegInfo\">"+
                          "<p class=\"OtroSegCod\">Código: <span>QWERTY123</span></p>"+
                          "<p class=\"OtroSegDesc\"> "+items[i]['t02_descripcion']+
            ...
            if(flag_col<3){
              ...
              " href=\"#modal-container-otroseg0"+i+"\">"+
              "MÁS DETALLE</a></div></div>";
